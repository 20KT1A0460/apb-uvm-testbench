...
def generate_summary():
    ...
    test_cases = ["test", "test_error", "test_sinlge_write_read", "test_even_write_read", "test_odd_write_read", "test_multi_slve_on","test_full_write_read","test_multi_slve_write_read"]
